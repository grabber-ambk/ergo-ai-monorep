...
__export(index_exports, {
    AuthProvider: function() {
        return AuthProvider_default;
    },
    QuoteProvider: function() {
        return QuoteProvider_default;
    },
    useAuthContext: function() {
        return useAuthContext;
    },
    useQuoteContext: function() {
...
var AuthProvider = function(param) {
    ...
    var _ref = _sliced_to_array((0, import_react.useState)(false), 2), showLoginModal = _ref[0], setShowLoginModal = _ref[1];
    var _ref1 = _sliced_to_array((0, import_react.useState)(false), 2), showSignupModal = _ref1[0], setShowSignupModal = _ref1[1];
    var _ref2 = _sliced_to_array((0, import_react.useState)("BR"), 2), selectedCountry = _ref2[0], setSelectedCountry = _ref2[1];
    var _ref3 = _sliced_to_array((0, import_react.useState)({
        ...
        email: "",
        phone: "+55"
    }), 2), signupFormData = _ref3[0], setSignupFormData = _ref3[1];
...
var useAuthContext = function() {
    var context = (0, import_react.useContext)(AuthContext);
    if (context === void 0) {
...
var import_hooks = require("@ergo-ai/hooks");
var import_jsx_runtime2 = require("react/jsx-runtime");
var QuoteContext = (0, import_react2.createContext)(void 0);
var QuoteProvider = function(param) {
    var children = param.children, resetUpload = param.resetUpload;
    var _ref = (0, import_hooks.useQuoteStages)(), quoteStage = _ref.quoteStage, setQuoteStage = _ref.setQuoteStage, quoteData = _ref.quoteData, setQuoteData = _ref.setQuoteData, activeTab = _ref.activeTab, setActiveTab = _ref.setActiveTab, baseHandleGenerateQuote = _ref.handleGenerateQuote, baseHandleGenerateAdvancedQuote = _ref.handleGenerateAdvancedQuote, handleConfirmQuote = _ref.handleConfirmQuote, baseHandleNewQuote = _ref.handleNewQuote, handleTabChange = _ref.handleTabChange;
    var _ref1 = (0, import_hooks.useAdvancedForm)(), formData = _ref1.formData, handleFormChange = _ref1.handleFormChange;
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(QuoteContext.Provider, {
        value: value,
        children: children
    });
};
var useQuoteContext = function() {
    var context = (0, import_react2.useContext)(QuoteContext);
    if (context === void 0) {
...
0 && (module.exports = {
    ...
    useQuoteContext: useQuoteContext
});
